                            ...
                            <main class="main">     
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-line">
                                                <select name="eye" class="form-control form-control-sm text">
                                    ...
                                    <table id="dataTable" class="table table-bordered table-striped table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($peoplerequirement)
                                                        @if ($peoplerequirement->eye)
                                                            {{$peoplerequirement->eye}}
                                                        @else
                                                            <span class="badge badge-danger">No cargado</span>
                                                        @endif
                                                    @else
                                                ...
                                                <td>
                                                    @if ($peoplerequirement)
                                                        @if ($peoplerequirement->video)
                                                            {{-- <span class="badge badge-success">Si cargado</span> --}}
                                                            <a href="{{asset('storage/'.$peoplerequirement->video)}}" title="Ver" target="_blank" class="btn btn-sm btn-success">
                                                                <i class="fa-solid fa-file"></i> <span class="hidden-xs hidden-sm">Ver</span>
                                                            </a>
                                                        @else
                                                            <span class="badge badge-danger">No cargado</span>
