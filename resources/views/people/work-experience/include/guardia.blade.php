                                                ...
                                                <td>
                                                    @if ($peoplerequirement)
                                                        @if ($peoplerequirement->image_ap)
                                                            {{-- <span class="badge badge-success">Si cargado</span> --}}
                                                            <a href="{{asset('storage/'.$peoplerequirement->image_ap)}}" title="Ver" target="_blank" class="btn btn-sm btn-success">
                                                ...
                                                <td>
                                                    @if ($peoplerequirement)
                                                        @if ($peoplerequirement->image_lsm)
                                                            <a href="{{asset('storage/'.$peoplerequirement->image_lsm)}}" title="Ver" target="_blank" class="btn btn-sm btn-success">
                                                                <i class="fa-solid fa-file"></i> <span class="hidden-xs hidden-sm">Ver</span>
                                                            </a>
                                                        @else
                                                            <span class="badge badge-danger">No cargado</span>
                                                ...
                                                <td>
                                                    @if ($peoplerequirement)
                                                        @if ($peoplerequirement->image_fcc)
                                                            <a href="{{asset('storage/'.$peoplerequirement->image_fcc)}}" title="Ver" target="_blank" class="btn btn-sm btn-success">
                                                                <i class="fa-solid fa-file"></i> <span class="hidden-xs hidden-sm">Ver</span>
                                                            </a>
                                                        @else
                                                            <span class="badge badge-danger">No cargado</span>
