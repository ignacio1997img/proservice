...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">ProService</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="getstarted scrollto" href="{{ url('admin') }}">INICIE SESIÓN</a></li>
        </ul>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-2 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <div class="mt-3">
            <a href="{{route('people.create')}}" class="btn-get-started scrollto">Busco Trabajo</a>
            <a href="{{route('beneficiary.create')}}" class="btn-get-quote">Busco Empresa</a>
          </div>
        </div>
