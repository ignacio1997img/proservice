                ...
                @if ($businerequirements)
                    @if ($businerequirements->image_lf)
                        ...
                        @if(auth()->user()->hasPermission('view_busine-perfil-requirement'))
                            <a href="{{asset('storage/'.$businerequirements->image_lf)}}" title="Ver" target="_blank" class="btn btn-sm btn-success">
            ...
            <td>
                @if ($businerequirements)
                    @if ($businerequirements->image_roe)
                        <span class="badge badge-success">Si cargado</span>
                        @if(auth()->user()->hasPermission('view_busine-perfil-requirement'))
                            <a href="{{asset('storage/'.$businerequirements->image_roe)}}" title="Ver" target="_blank" class="btn btn-sm btn-success">
                                <i class="voyager-eye"></i> <span class="hidden-xs hidden-sm">Ver</span>
                            </a>
                        @endif
                    @else
            ...
            <td>
                @if ($businerequirements)
                    @if ($businerequirements->image_pd)
                        <span class="badge badge-success">Si cargado</span>
                        @if(auth()->user()->hasPermission('view_busine-perfil-requirement'))
                            <a href="{{asset('storage/'.$businerequirements->image_pd)}}" title="Ver" target="_blank" class="btn btn-sm btn-success">
                                <i class="voyager-eye"></i> <span class="hidden-xs hidden-sm">Ver</span>
                            </a>
                        @endif
                    @else
                ...
                <div class="modal-body">
                    ...
                    <div id="cantcheque">                                   
                        <div class="row" >
                            ...
                            <div class="col-md-6">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><b>Permiso de denacev:</b></span>
                                </div>
                                <input type="file" name="image_pd"  multiple class="form-control" accept="image/*">
                            </div>                           
                        </div>
                    </div>
