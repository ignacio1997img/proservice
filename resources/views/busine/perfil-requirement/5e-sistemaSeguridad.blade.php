                        ...
                        <td style="text-align: center">
                            ...
                            @else                                                                
                                <a href="{{asset('storage/'.$businerequirements->image_nit)}}" title="Ver" target="_blank">
                                    <img src="{{asset('storage/'.$businerequirements->image_nit)}}" href="{{asset('storage/'.$businerequirements->image_nit)}}" class="zoom" style="width: 60px; height: 60px; border-radius: 30px; margin-right: 10px"/>
                                </a> 
                            @endif
                        </td>
                    </tr>
                        ...
                        <td style="text-align: center">
                            ...
                            @else                                                                
                                <a href="{{asset('storage/'.$businerequirements->image_lf)}}" title="Ver" target="_blank">
                                    <img src="{{asset('storage/'.$businerequirements->image_lf)}}" href="{{asset('storage/'.$businerequirements->image_lf)}}" class="zoom" style="width: 60px; height: 60px; border-radius: 30px; margin-right: 10px"/>
                                </a> 
                            @endif
                        </td>
                    </tr>
                        ...
                        <td style="text-align: center">
                            ...
                            @else
                                <a href="{{asset('storage/'.$businerequirements->image_roe)}}" title="Ver" target="_blank">
                                    <img src="{{asset('storage/'.$businerequirements->image_roe)}}" href="{{asset('storage/'.$businerequirements->image_roe)}}" class="zoom" style="width: 60px; height: 60px; border-radius: 30px; margin-right: 10px"/>
                                </a> 
                            @endif
                        </td>
                    </tr>
                        ...
                        <td style="text-align: center">
                            ...
                            @else
                                <a href="{{asset('storage/'.$businerequirements->image_pd)}}" title="Ver" target="_blank">
                                    <img src="{{asset('storage/'.$businerequirements->image_pd)}}" href="{{asset('storage/'.$businerequirements->image_pd)}}" class="zoom" style="width: 60px; height: 60px; border-radius: 30px; margin-right: 10px"/>
                                </a>                                                                
                            @endif                                                            
                        </td>
                    </tr>
                    ...
                    <input type="hidden" name="busine_id" value="{{$busine->id}}">
                        ...
                        <div class="row" >
                            <div class="form-group col-md-6">
                                ...
                                <input type="file" accept="image/jpeg,image/jpg,image/png" name="image_nit" class="form-control imageLength">                            
                            </div>
                            <div class="form-group col-md-6">
                                <small>Licencia de funcionamiento *imagen</small>                            
                                <input type="file" accept="image/jpeg,image/jpg,image/png" name="image_lf" class="form-control imageLength">                            
                            </div>
                            <div class="form-group col-md-6">
                                <small>Roe *imagen</small>                            
                                <input type="file" accept="image/jpeg,image/jpg,image/png" name="image_roe" class="form-control imageLength">                            
                            </div>
                            <div class="form-group col-md-6">
                                <small>Permiso de denacev *imagen</small>                            
                                <input type="file" accept="image/jpeg,image/jpg,image/png" name="image_pd" class="form-control imageLength">                            
                            </div>                         
                        </div>
